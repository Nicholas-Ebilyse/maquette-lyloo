...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-vert-eau via-vert-pale to-terracotta-lyloo/20">
      <Navigation />
      
      {/* Hero Section with Brand Image */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-terracotta-lyloo/30 to-marron-chaud/20"></div>
